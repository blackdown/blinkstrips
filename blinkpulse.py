...
sensitivity = 0.8 # Sensitivity to sound.
...
if __name__ == '__main__':
	...
	leds = notes_scaled_nosaturation.process(audio, num_leds=32, num_samples=128, sample_rate=44100, sensitivity=sensitivity)
