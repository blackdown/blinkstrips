...
speed = 0.5 # 2 is 2x speed, .5 is half speed, you get the idea.
fps = 50.0 # Frames per second of the animation. 50 is about the upper limit.
cut = 1 # how much of the spectrum to show. 1 = full spectrum, 2 = 2 full spectrums, .5 is half a spectrum.
brightness = 1 # Brightness of animation from 0 to 1
...
while True:
    ...
    for i in range(1,cnt+1):
        (r, g, b) = hsv_to_rgb(i/float(cnt*(1.0/cut))+time()*0.5, 1, brightness)
